...
class MainPage(webapp2.RequestHandler):
    def get(self):
        ...
        if user is not None:
            template = JINJA_ENVIRONMENT.get_template('files/index.html')
            self.response.write(template.render(template_data))
        else:
            self.redirect('/login');

class ID(webapp2.RequestHandler):
    def get(self):
        template = JINJA_ENVIRONMENT.get_template('files/ID.html')
...
class LoginPage(webapp2.RequestHandler):
    def get(self):
        ...
        if user is not None:
            ...
            template = JINJA_ENVIRONMENT.get_template('files/front/login.html')
            self.response.write(template.render(template_data))
    ...
    def get(self):
        ...
        if user is not None:
            ...
            if entity is not None:
                ...
                template = JINJA_ENVIRONMENT.get_template('files/front/register.html')
...
class ThesisCreate(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/thesis/thesis_create.html')
        self.response.write(template.render(template_data))
...
class APIHandlerPage(webapp2.RequestHandler):
    ...
    def post(self):
        ...
        if len(th) >= 1:
            self.response.headers['Content-Type'] = 'application/json'
            response = {
                'status':'Unsuccessful! Title already exist.'
            }
            self.response.out.write(json.dumps(response))
...
class  ThesisEdit(webapp2.RequestHandler):
    def get(self,th_id):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/thesis/thesis_edit.html')
        self.response.write(template.render(template_data))
...
class StudentPage(webapp2.RequestHandler):
    def get(self,s_id):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/student/student_profile.html')
        self.response.write(template.render(template_data))
    def post(self,s_id):
        s = Student.get_by_id(int(s_id))
...
class FacultyPage(webapp2.RequestHandler):
    def get(self,f_id):
        ...
        template = JINJA_ENVIRONMENT.get_template('/files/faculty/faculty_profile.html')
        self.response.write(template.render(template_data))
    def post(self,f_id):
        f = Faculty.get_by_id(f_id)
...
class UniversityPage(webapp2.RequestHandler):
    def get(self,u_id):
        ...
        template = JINJA_ENVIRONMENT.get_template('/files/university/university_profile.html')
        self.response.write(template.render(template_data))
    def post(self,u_id):
        u = University.get_by_id(int(u_id))
...
class CollegePage(webapp2.RequestHandler):
    def get(self,c_id):
        ...
        template = JINJA_ENVIRONMENT.get_template('/files/college/college_profile.html')
        self.response.write(template.render(template_data))
    def post(self,c_id):
        c = College.get_by_id(int(c_id))
...
class ThesisList(webapp2.RequestHandler):
    def get(self):
        ...
        if user:
            template = JINJA_ENVIRONMENT.get_template('files/thesis/thesis_list.html')
            self.response.write(template.render(template_data))
        else:
            self.redirect('/login');
...
class ThesisListAll(webapp2.RequestHandler):
    def get(self):
        ...
        if user:
            template = JINJA_ENVIRONMENT.get_template('files/thesis/ThesisListAll.html')
            self.response.write(template.render(template_data))
        else:
            self.redirect('/login');
class CreateFaculty(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/faculty/faculty_create.html')
        self.response.write(template.render(template_data))
    def post(self):
        obj = json.loads(self.request.body)
...
class CreateStudent(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/student/student_create.html')
        self.response.write(template.render(template_data))
    def post(self):
        obj = json.loads(self.request.body)
        ...
        if s:
            for student in s:
                if student.stud_fname == first_name and student.stud_mname == middle_name:
                    self.response.headers['Content-Type'] = 'application/json'
                    response = {
                        'status':'Student has a record already!',
                    }
                    self.response.out.write(json.dumps(response))
                    return
                else:
...
class CreateUniversity(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/university/university_create.html')
        self.response.write(template.render(template_data))
    def post(self):
...
class CreateCollege(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/college/college_create.html')
        self.response.write(template.render(template_data))
    def post(self):
...
class CreateDepartment(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/department/department_create.html')
        self.response.write(template.render(template_data))
    def post(self):
...
class ListFaculty(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/faculty/faculty_list.html')
        self.response.write(template.render(template_data))
...
class ListStudent(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/student/student_list.html')
        self.response.write(template.render(template_data))
...
class ListUniversity(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/university/university_list.html')
        self.response.write(template.render(template_data))
...
class ListCollege(webapp2.RequestHandler):
    def get(self):
        ...
        template = JINJA_ENVIRONMENT.get_template('files/college/college_list.html')
        self.response.write(template.render(template_data))
